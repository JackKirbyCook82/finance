...
IdentityField = Field("identity", int)
...
SymbolQuery = Query("Symbol", fields=[TickerField, IdentityField], delimiter="|")
...
ContractQuery = Query("Contract", fields=[TickerField, ExpireField, OptionField, StrikeField, IdentityField], delimiter="|")
