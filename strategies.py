...
class StrategyEquationMeta(RegistryMeta, type(Equation), ABCMeta): pass
class StrategyEquation(Computations.Array, Algorithms.UnVectorized.Array, Equation, ABC, metaclass=StrategyEquationMeta):
